...
export default function MainCard({
  ...
  return (
    <div className="card w-full min-h-[250px] relative after:absolute after:inset-[3px] md:after:inset-[4px] before:inset-[3px] md:before:inset-[4px] before:absolute before:bg-[#1010103b] rounded-md after:rounded-md before:rounded-md">
      ...
      <div className="contenido rounded-md w-full h-full absolute top-0 left-0 z-20 after:rounded-md after:inset-[3px] md:after:inset-[4px] after:absolute after:bg-gradient-to-t after:from-[#101010] after:via-transparent after:to-transparent flex flex-col justify-between p-2 md:p-3 xl:p-4">
