...
export default function MainInfo({
  ...
  return (
    <div className="main-info relative sm:flex sm:flex-col sm:gap-4">
      <div className="imagen max-w-[500px] mx-auto sm:max-w-[250px] md:max-w-full w-full sm:rounded-md sm:overflow-hidden sm:after:hidden relative after:absolute after:inset-0 after:from-[#101010] after:bg-gradient-to-t after:from-10% after:to-transparent after:via-transparent">
        <Image
